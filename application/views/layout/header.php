...
<head>
	...
	<title>BKPSDM PPAYAKUMBUH - <?=$title?></title>
	<!-- Favicon icon -->
	...
	<div id="main-wrapper">
						...
						<ul class="navbar-nav header-right">
							...
							<li class="nav-item dropdown header-profile">
								<a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
									<img src="<?=base_url();?>assets/images/icon-admin.png" width="20" alt="" />

									<div class="header-info">
										<span
											class="text-black"><strong><?=$this->session->userdata('email')?></strong></span>
										<p class="fs-12 mb-0"><?=$this->session->userdata('role')?></p>
									</div>
								</a>
								<div class="dropdown-menu dropdown-menu-right">
									<?php if ($this->session->userdata('role') == 'mitra'): ?>
									<a href="<?=base_url()?>user/profil" class="dropdown-item ai-icon">
									...
									<?php endif;?>
									<a href="<?=base_url()?>controller/logout" class="dropdown-item ai-icon">
        ...
        ***********************************-->
		<script>
			...
			// });
			// function hideMenu() {
			// 	$("#main-wrapper").toggleClass("show menu-toggle");
			//  }
		</script>
